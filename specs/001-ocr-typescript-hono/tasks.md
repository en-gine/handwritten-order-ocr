...
- [ ] T025 [P] Define FileStorage interface in src/lib/storage/interface.ts
- [ ] T026 [P] Implement configuration loader for AI model, thresholds, storage settings in src/lib/config.ts

### Authentication & Multi-Tenancy

- [ ] T027 Implement JWT authentication middleware in src/api/middleware/auth.ts (RS256 verification, extract tenant_id claim)
...
- [ ] T032 Initialize Hono app in src/api/index.ts with CORS, error handling, and middleware chain
- [ ] T033 Create health check endpoint GET /health in src/api/routes/health.ts
